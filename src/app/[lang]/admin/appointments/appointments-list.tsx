...
export function AppointmentsList({ lang, appointments: initialAppointments }: AppointmentsListProps) {
  ...
  const t = {
    title: lang === "zh-TW" ? "所有預約" : "All Appointments",
    subtitle: lang === "zh-TW" ? "查看和管理所有預約記錄" : "View and manage all appointment records",
    back: lang === "zh-TW" ? "返回控制台" : "Back to Dashboard",
    create: lang === "zh-TW" ? "創建新預約" : "Create New",
    search: lang === "zh-TW" ? "搜索預約..." : "Search appointments...",
    filters: {
      all: lang === "zh-TW" ? "全部" : "All",
    ...
    appointments_count: lang === "zh-TW" ? "個預約" : "appointments",
    noAppointments: lang === "zh-TW" ? "沒有找到預約" : "No appointments found",
    ...
    description: lang === "zh-TW" ? "描述" : "Description",
    actions: {
      edit: lang === "zh-TW" ? "編輯" : "Edit",
      save: lang === "zh-TW" ? "保存" : "Save",
      cancel: lang === "zh-TW" ? "取消" : "Cancel",
      complete: lang === "zh-TW" ? "完成" : "Complete",
      cancelApt: lang === "zh-TW" ? "取消預約" : "Cancel",
      reschedule: lang === "zh-TW" ? "重新預約" : "Reschedule",
      undoComplete: lang === "zh-TW" ? "撤銷完成" : "Undo Complete",
      delete: lang === "zh-TW" ? "刪除" : "Delete",
    },
    editTitle: lang === "zh-TW" ? "編輯預約" : "Edit Appointment",
    deleteConfirm: lang === "zh-TW" ? "確定要刪除此預約嗎？" : "Are you sure you want to delete this appointment?",
  }
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      ...
      case "scheduled": return t.filters.scheduled
      case "completed": return t.filters.completed
      case "cancelled": return t.filters.cancelled
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild className="bg-[#00477f] hover:bg-[#003d70]">
            <Link href={`/${lang}/admin/appointments/new`}>
      ...
      <p className="text-sm text-gray-600">
        {t.showing} {filteredAppointments.length} {t.appointments_count}
      </p>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>{t.user}: {appointment.user.name || appointment.user.email}</span>
                      </div>
